...
export class Tariff extends Model<TariffProps> {
	...
	private constructor({origin, destination, valuePerMinute} : TariffProps, id?: string) {
		super(id)
	...
	static create({origin, destination, valuePerMinute}: CreateTariffInput, id?: string) {
		return new Tariff({
